...
const updateMyProfile = (0, catchAsync_1.default)(async (req, res) => {
    ...
    const verifiedToken = req.user;
    const payload = req.body;
    // ✅ Handle profile picture from Cloudinary (multer)
    if (req.file) {
...
//   });
// });
// // // ✅ Sir's style - Update user with proper authorization
// // const updateUser = catchAsync(async (req: Request, res: Response) => {
// //   const userId = req.params.id; // URL থেকে userId নিন
// //   const verifiedToken = req.user; // authGuard থেকে আসা ইউজার ডাটা
// //   const payload = req.body;
...
//   const userId = (req as any).user._id; // Token থেকে userId নিন
//   const verifiedToken = req.user;
//   const payload = req.body;
//   console.log('=== UPDATE MY PROFILE REQUEST ===');
//   console.log('User ID:', userId);
//   console.log('Payload:', payload);
//   const user = await UserServices.updateUser(
//     userId,
...
// const updateUser = catchAsync(async (req: Request, res: Response) => {
//   const userId = req.params.id; // URL থেকে userId
//   const verifiedToken = req.user;
//   const payload = req.body;
//   console.log('=== UPDATE USER REQUEST ===');
//   console.log('User ID:', userId);
...
//   sendResponse(res, {
//     success: true,
//     statusCode: httpStatus.OK, // আপডেট সফল হলে সাধারণত OK পাঠানো হয়
//     message: "User Updated Successfully",
//     data: user,
//   });
// });
