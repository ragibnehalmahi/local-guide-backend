...
const sslPaymentInit = async (payload) => {
    try {
        ...
        if (!response.data || response.data.status !== 'SUCCESS') {
            throw new AppError_1.default(http_status_codes_1.default.BAD_REQUEST, response.data?.failedreason || "SSLCommerz initialization failed");
        }
        return response.data;
    }
    catch (error) {
        console.error("❌ SSLCommerz Error:", error.message);
        throw new AppError_1.default(http_status_codes_1.default.BAD_REQUEST, error.message || "Payment initialization failed");
    }
};
const validatePayment = async (payload) => {
    try {
        ...
        throw new AppError_1.default(http_status_codes_1.default.BAD_REQUEST, `Payment validation failed: ${error.message}`);
    }
};
exports.SSLService = {
    sslPaymentInit,
